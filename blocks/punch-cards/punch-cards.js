...
export default function decorate(block) {
  ...
  [...block.children].forEach((row) => {
    ...
    [...li.children].forEach((div) => {
      if (div.children.length === 1 && div.querySelector('picture')) div.className = 'punch-card-image';
      else div.className = 'punch-card-body';
    });
    ul.append(li);
  });
  ...
  const carousel = document.querySelector('.punch-cards');
